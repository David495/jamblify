...
import EnglishQuestions from "../../../questions/eglishquestion.json";
...
const FINAL_QUESTIONS = shuffleArray(EnglishQuestions).slice(0, 20);
  ...
  return (
    <>
      ...
      <main className="flex justify-center items-center h-screen flex-col">
        ...
        <section className="bg-blue-900 p-5 md:p-6 rounded flex flex-col gap-10 max-w-[350px] md:max-w-[600px] w-full">
          <section>
